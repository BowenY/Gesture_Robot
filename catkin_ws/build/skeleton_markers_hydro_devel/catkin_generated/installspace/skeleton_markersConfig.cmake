...
if("FALSE" STREQUAL "TRUE")
  set(skeleton_markers_SOURCE_PREFIX /home/jian/catkin_ws/src/skeleton_markers_hydro_devel)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'skeleton_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jian/catkin_ws/install/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
